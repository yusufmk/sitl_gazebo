...
public:
  GazeboMavlinkInterface();	// WARNING !!! BUARDA BISSURU DEGISKEN INIT LIST ILE TANIMLANIYORDU GITMIS
...
private:
  ...
  double abs_pressure_;
	...
	// WARNING !!!! BURADA SOKETLE ILGILI DEGISKENLER TANIMLANIYORDU GITMIS
